...
# validation set path
DATA_DIRECTORY = './dataset/donnees/Dark_Zurich_val_anon/rgb_anon/val'
DATA_LIST_PATH = './dataset/lists/newdata.txt'

#DATA_LIST_PATH = './dataset/lists/zurich_val.txt'
# test set path
# DATA_DIRECTORY = './dataset/donnees/public_data_2/rgb_anon'
